...
const HousingCard = () => {
  return (
    <div className="col-4 m-3 d-flex">
      <div className="">
        <img className="card-img-top card-img-sizing" alt="pic" src="https://images.pexels.com/photos/7174114/pexels-photo-7174114.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"  />
      </div>
